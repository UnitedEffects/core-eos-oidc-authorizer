...
const config = {
    ...
    AUD: (process.env.AUD !== "") ? process.env.AUD : (envVars.AUD !== "") ? envVars.AUD : null,
    PKCE: (process.env.PKCE === 'true') || envVars.PKCE || false,
    CLIENT_ID: process.env.CLIENT_ID || envVars.CLIENT_ID || null,
    CLIENT_SECRET: (process.env.CLIENT_SECRET !== "") ? process.env.CLIENT_SECRET : (envVars.CLIENT_SECRET !== "") ? envVars.CLIENT_SECRET : null,
    GET_USER: (process.env.GET_USER === 'true') || envVars.GET_USER || false,
    INCLUDE_CONTEXT: (process.env.INCLUDE_CONTEXT === 'true') || envVars.INCLUDE_CONTEXT || true,
};
